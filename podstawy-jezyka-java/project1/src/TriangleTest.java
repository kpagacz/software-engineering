...
class TriangleTest {
    ...
    void testIsoscelesTriangle() throws ImpossiblePolygonException {
        ArrayList<Vertex> vertices = new ArrayList<>(List.of(new Vertex(-1, 0), new Vertex(1, 0), new Vertex(0, 3)));
    ...
    void testScaleneTriangle() throws ImpossiblePolygonException {
        ArrayList<Vertex> vertices = new ArrayList<>(List.of(new Vertex(0, 0), new Vertex(1, 0), new Vertex(0, 3)));
        Triangle triangle = new Triangle(vertices);
    ...
    void testEquilateralTriangle() throws ImpossiblePolygonException {
        ArrayList<Vertex> vertices = new ArrayList<>(List.of(new Vertex(0, 0), new Vertex(1, 0), new Vertex(0.5, Math.sqrt(3) / 2)));
        Triangle triangle = new Triangle(vertices);
    ...
    void testRightTriangle() throws ImpossiblePolygonException {
        ArrayList<Vertex> vertices = new ArrayList<>(List.of(new Vertex(0, 0), new Vertex(1, 0), new Vertex(0, 1)));
        Triangle triangle = new Triangle(vertices);
    ...
    void testObtuseTriangle() throws ImpossiblePolygonException {
        ArrayList<Vertex> vertices = new ArrayList<>(List.of(new Vertex(0, 0), new Vertex(1, 0), new Vertex(-0.2, 1)));
        Triangle triangle = new Triangle(vertices);
