...
grant connect, resource, create view, create role, create public synonym to pbd;
...
grant connect, resource, create view, create role, create public synonym to kadry;
disconnect
conn kadry/kadry@xe
...
od DATE,
do DATE,
CONSTRAINT kierowcy_PK PRIMARY KEY (id_w, od)
);
-- Tworzenie indeksów
