...
namespace lab_11
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            openFileDialog.Filter = "BMP|*.bmp|PNG|*.png|JPG|*.jpg|JPEG|*.jpeg|SVG|*.svg";
            saveFileDialog.Filter = "BMP|*.bmp|PNG|*.png|JPG|*.jpg|JPEG|*.jpeg|SVG|*.svg";
        ...
        private void pictureBox_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                {
                    picture.Shapes.Add(new Line(paintPen.Clone() as Pen, tempPosition, e.Location));
                }
